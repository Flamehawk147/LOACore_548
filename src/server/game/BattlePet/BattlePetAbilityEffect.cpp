...
static BattlePetAbilityEffectHandler Handlers[PET_BATTLE_TOTAL_ABILITY_EFFECTS] =
{
    ...
    /* Effect 030 */ { &BattlePetAbilityEffect::HandleSetState,                 PET_BATTLE_ABILITY_TARGET_TARGET },
    ...
    /* Effect 033 */ { &BattlePetAbilityEffect::HandleStopChainFailure,         PET_BATTLE_ABILITY_TARGET_TARGET },
    /* Effect 034 */ { &BattlePetAbilityEffect::HandleNegativeAura,             PET_BATTLE_ABILITY_TARGET_TARGET },
    /* Effect 035 */ { &BattlePetAbilityEffect::HandlePeriodicTrigger,          PET_BATTLE_ABILITY_TARGET_CASTER },
    /* Effect 036 */ { &BattlePetAbilityEffect::HandlePeriodicPositiveTrigger,  PET_BATTLE_ABILITY_TARGET_CASTER },
    /* Effect 037 */ { &BattlePetAbilityEffect::HandleDamageToggleAura,         PET_BATTLE_ABILITY_TARGET_TARGET },
    /* Effect 038 */ { &BattlePetAbilityEffect::HandleDamageHitState,           PET_BATTLE_ABILITY_TARGET_TARGET },
    /* Effect 039 */ { &BattlePetAbilityEffect::HandleExtraAttackFirst,         PET_BATTLE_ABILITY_TARGET_TARGET },
    /* Effect 040 */ { &BattlePetAbilityEffect::HandleHealState,                PET_BATTLE_ABILITY_TARGET_CASTER },
    /* Effect 041 */ { &BattlePetAbilityEffect::HandleDamageNonLethal,          PET_BATTLE_ABILITY_TARGET_TARGET },
    /* Effect 042 */ { &BattlePetAbilityEffect::HandlePowerlessAura,            PET_BATTLE_ABILITY_TARGET_TARGET },
    /* Effect 043 */ { &BattlePetAbilityEffect::HandleExtraAttack,              PET_BATTLE_ABILITY_TARGET_TARGET },
    /* Effect 044 */ { &BattlePetAbilityEffect::HandleHealLastHitTaken,         PET_BATTLE_ABILITY_TARGET_CASTER },
    /* Effect 045 */ { &BattlePetAbilityEffect::HandleResurect,                 PET_BATTLE_ABILITY_TARGET_CASTER },
    /* Effect 046 */ { &BattlePetAbilityEffect::HandleHealOnSpecificWeather,    PET_BATTLE_ABILITY_TARGET_CASTER },
    /* Effect 047 */ { &BattlePetAbilityEffect::HandleWeatherAura,              PET_BATTLE_ABILITY_TARGET_CASTER },
    /* Effect 048 */ { &BattlePetAbilityEffect::HandleWeatherDamage,            PET_BATTLE_ABILITY_TARGET_TARGET },
    ...
    /* Effect 051 */ { &BattlePetAbilityEffect::HandleDamagePercentTaken,       PET_BATTLE_ABILITY_TARGET_TARGET },
    ...
    /* Effect 055 */ { &BattlePetAbilityEffect::HandleDamageStateBonus,         PET_BATTLE_ABILITY_TARGET_TARGET },
    /* Effect 056 */ { &BattlePetAbilityEffect::HandleResetState,               PET_BATTLE_ABILITY_TARGET_TARGET },
    /* Effect 057 */ { &BattlePetAbilityEffect::HandleSplittedDamage,           PET_BATTLE_ABILITY_TARGET_TARGET },
    /* Effect 058 */ { &BattlePetAbilityEffect::HandleResetAuraDuration,        PET_BATTLE_ABILITY_TARGET_TARGET },
    /* Effect 059 */ { &BattlePetAbilityEffect::HandleWitchingDamage,           PET_BATTLE_ABILITY_TARGET_TARGET   },
    /* Effect 060 */ { &BattlePetAbilityEffect::HandleHeal,                     PET_BATTLE_ABILITY_TARGET_TARGET },
    ...
    /* Effect 064 */ { &BattlePetAbilityEffect::HandleKill,                     PET_BATTLE_ABILITY_TARGET_TARGET },
    ...
    /* Effect 069 */ { &BattlePetAbilityEffect::HandleInitialization,           PET_BATTLE_ABILITY_TARGET_CASTER },
    /* Effect 070 */ { &BattlePetAbilityEffect::HandleHealStateToggleAura,      PET_BATTLE_ABILITY_TARGET_CASTER },
    /* Effect 071 */ { &BattlePetAbilityEffect::HandleModState,                 PET_BATTLE_ABILITY_TARGET_TARGET },
    /* Effect 072 */ { &BattlePetAbilityEffect::HandleHealToggleAura,           PET_BATTLE_ABILITY_TARGET_CASTER   },
    /* Effect 073 */ { &BattlePetAbilityEffect::HandleHealthConsume,            PET_BATTLE_ABILITY_TARGET_CASTER },
    ...
    /* Effect 081 */ { &BattlePetAbilityEffect::HandleSwap,                     PET_BATTLE_ABILITY_TARGET_CASTER },
    /* Effect 082 */ { &BattlePetAbilityEffect::HandleUpdatePriority,           PET_BATTLE_ABILITY_TARGET_CASTER },
    /* Effect 083 */ { &BattlePetAbilityEffect::HandleSetHealthPercent,         PET_BATTLE_ABILITY_TARGET_TARGET },
    /* Effect 084 */ { &BattlePetAbilityEffect::HandleLockActiveAbility,        PET_BATTLE_ABILITY_TARGET_TARGET },
    ...
    /* Effect 087 */ { &BattlePetAbilityEffect::HandleAuraIfCasterFaster,       PET_BATTLE_ABILITY_TARGET_TARGET },
    /* Effect 088 */ { &BattlePetAbilityEffect::HandleCleansing,                PET_BATTLE_ABILITY_TARGET_TARGET },
    /* Effect 089 */ { &BattlePetAbilityEffect::HandleAuraState,                PET_BATTLE_ABILITY_TARGET_TARGET },
    /* Effect 090 */ { &BattlePetAbilityEffect::HandleChangeCasterState,        PET_BATTLE_ABILITY_TARGET_CASTER },
    /* Effect 091 */ { &BattlePetAbilityEffect::HandleSwapLow,                  PET_BATTLE_ABILITY_TARGET_CASTER },
    /* Effect 092 */ { &BattlePetAbilityEffect::HandleResetAuraDuration,        PET_BATTLE_ABILITY_TARGET_CASTER },
    /* Effect 093 */ { &BattlePetAbilityEffect::HandleSwapHigh,                 PET_BATTLE_ABILITY_TARGET_CASTER },
    /* Effect 094 */ { &BattlePetAbilityEffect::HandleRedirectionAura,          PET_BATTLE_ABILITY_TARGET_CASTER },
    /* Effect 095 */ { &BattlePetAbilityEffect::HandleCheckFailure,             PET_BATTLE_ABILITY_TARGET_TARGET },
    /* Effect 096 */ { &BattlePetAbilityEffect::HandleDamageHitState,           PET_BATTLE_ABILITY_TARGET_TARGET },
    /* Effect 097 */ { &BattlePetAbilityEffect::HandleKill,                     PET_BATTLE_ABILITY_TARGET_CASTER },
    /* Effect 098 */ { &BattlePetAbilityEffect::HandleUpdatePriority,           PET_BATTLE_ABILITY_TARGET_TARGET },
    /* Effect 099 */ { &BattlePetAbilityEffect::HandleTryRevive,                PET_BATTLE_ABILITY_TARGET_CASTER },
    /* Effect 100 */ { &BattlePetAbilityEffect::HandleHealPercent,              PET_BATTLE_ABILITY_TARGET_TARGET },
    /* Effect 101 */ { &BattlePetAbilityEffect::HandleUpdatePriority,           PET_BATTLE_ABILITY_TARGET_ALL    },
    /*   UNUSED   */ { &BattlePetAbilityEffect::HandleNull,                     PET_BATTLE_ABILITY_TARGET_NONE   },
    ...
    /* Effect 105 */ { &BattlePetAbilityEffect::HandleCheckState,               PET_BATTLE_ABILITY_TARGET_TARGET },
    /* Effect 106 */ { &BattlePetAbilityEffect::HandleHealPetType,              PET_BATTLE_ABILITY_TARGET_CASTER },
    ...
    /* Effect 165 */ { &BattlePetAbilityEffect::HandleTryRevive,                PET_BATTLE_ABILITY_TARGET_CASTER },
    /*   UNUSED   */ { &BattlePetAbilityEffect::HandleNull,                     PET_BATTLE_ABILITY_TARGET_NONE   },
    /*   UNUSED   */ { &BattlePetAbilityEffect::HandleNull,                     PET_BATTLE_ABILITY_TARGET_NONE   },
    ...
    /*   UNUSED   */ { &BattlePetAbilityEffect::HandleNull,                     PET_BATTLE_ABILITY_TARGET_NONE   },
    /*   UNUSED   */ { &BattlePetAbilityEffect::HandleNull,                     PET_BATTLE_ABILITY_TARGET_NONE   },
    /* Effect 177 */ { &BattlePetAbilityEffect::HandleCheckState,               PET_BATTLE_ABILITY_TARGET_TARGET },
    /* Effect 178 */ { &BattlePetAbilityEffect::HandlePowerlessAura,            PET_BATTLE_ABILITY_TARGET_TARGET },
    /* Effect 179 */ { &BattlePetAbilityEffect::HandleDamage,                   PET_BATTLE_ABILITY_TARGET_TARGET },
    /*   UNUSED   */ { &BattlePetAbilityEffect::HandleNull,                     PET_BATTLE_ABILITY_TARGET_NONE   },
    /*   UNUSED   */ { &BattlePetAbilityEffect::HandleNull,                     PET_BATTLE_ABILITY_TARGET_NONE   },
    /*   UNUSED   */ { &BattlePetAbilityEffect::HandleNull,                     PET_BATTLE_ABILITY_TARGET_NONE   },
    /*   UNUSED   */ { &BattlePetAbilityEffect::HandleNull,                     PET_BATTLE_ABILITY_TARGET_NONE   },
