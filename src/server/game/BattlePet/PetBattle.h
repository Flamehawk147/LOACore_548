...
class BattlePet
{
    ...
    public:
        ...
        /// Save
        void Save(CharacterDatabaseTransaction p_Transaction);

        /// When a player earn a pet it will insert into his account
        void AddToPlayer(Player* p_Player);
        void AddToPlayer(Player* p_Player, CharacterDatabaseTransaction p_Transaction);
...
class BattlePetInstance : public BattlePet
{
    ...
    public:
        ...
        /// Compatibility methods for achievement system
...
class PetBattle
{
    public:
        ...
        PetBattleTeam* GetTeam(uint64 p_PlayerGuid);
        
        /// Get caged pet (compatibility method)
        BattlePetInstance* GetCagedPet();
...
class PetBattleSystem
{
    ...
    public:
        ...
        PetBattle* GetPlayerPetBattle(uint64 p_PlayerGuid);
